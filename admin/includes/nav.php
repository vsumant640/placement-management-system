    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <!-- <a class="dropdown-item"href="http://localhost/phpmyadmin/index.php?route=/database/structure&db=placement">DATABASE</a> -->
      </li>
      <li class="nav-item" id="help">
        <!--<a class="nav-link" href="../dark/admin/index.php"><span class="badge badge-dark">Dark Theme</span></a>-->
        <a class="nav-link"href="http://localhost/phpmyadmin/index.php?route=/database/structure&db=placement">Database</a>
      </li>
    </ul>
