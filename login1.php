...
<body>
   ...
   <img src="images/task.svg" width="430px" style="z-index: 1;">
    ...
    <!-- <div class="content" style="margin-top: 160px; margin-left: 10px;"> -->
    	<!-- <h1 style="margin-left: 30px; font-size: 64px;"><b> </b><br>Training <br><b> and </b><br> Placement Cell</h1> <br> -->
        <!-- <img src="images/logo1.png" width="550px"> -->
    <!-- </div> -->

<!-- <div id="users" style="position: fixed; margin-left:center; margin-top:center; margin-right=center; margin-bottom: center;"> -->
    <div id="users" style="z-index: 1; position: center; margin-top: 10vh;">
