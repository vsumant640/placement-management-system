                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                    <label for="website">kt</label>
                                    <input type="text" class="form-control" id="website" name="kt" value="<?php echo $row['kt']; ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">UG Percentage</label>
                                ...
                                <div class="form-row justify-content-center">
									...
									font-weight: bold; background: linear-gradient(to left, #4181ED, #3F4261);">Save</button>
                                </div> <br> <br>
                                <?php
                            }
                        }
